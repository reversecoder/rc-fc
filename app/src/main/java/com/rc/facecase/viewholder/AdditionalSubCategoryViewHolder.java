 ...
 */
public class AdditionalSubCategoryViewHolder extends BaseViewHolder<SubCategory> {

    private String TAG = AdditionalSubCategoryViewHolder.class.getSimpleName();
    private TextView tvSubcategory;
    private LinearLayout llSubcategory;

    public AdditionalSubCategoryViewHolder(ViewGroup parent) {
            ...
            public void onClick(final View v) {
                ...
                if (itemsList != null && itemsList.size() > 0) {
                    ...
                    if (mItem != null) {
                        ...
                        switchActivity(data.getSub_category_name(), mItem,data.getIs_picture());
                    }
                } else {
    ...
    private void switchActivity(String subCategoryName, Items item,String isPicture) {
        Intent iFacePlay;
        if (isPicture.equalsIgnoreCase("1")){
            iFacePlay = new Intent(getContext(), PictureGamePlayActivity.class);
        } else {
